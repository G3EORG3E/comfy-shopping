...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            products: [{ id: 1, name: "jedna", price: 2500, count: 1, currency: 'Kč' }, { id: 2, name: "dva", price: 5700, count: 1, currency: 'Kč' }],
            currency: 'Kč'
        };
    },

    computed: {
        sumVAT: function sumVAT() {
            var sum = 0;
